...
#assign network contributor role to  enterprise-application on main-rg (rg-azure-terraform-aks-stage)
...
#assign network contributor role to  managed identity  on main-rg (rg-azure-terraform-aks-stage)
